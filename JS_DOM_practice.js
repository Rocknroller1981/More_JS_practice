document.querySelector('body').style = 'height: auto; display: flex; justify-content: center; align-items: center';
...
childMaker('<button class = "starter">Press me, i\'ll start it</button>')

document.querySelector('.starter').style = 'background: black; color: yellow; font-size: 24px';

document.querySelector('.starter').addEventListener('click', mainFunc);
